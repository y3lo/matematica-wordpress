 ...
 */
fotoramaVersion = "4.6.0", function(a, b, c, d, e) {
    "use strict";
    function f(a) {
    ...
    function z(a, b) {
        ...
        return c && d || !b || (c = a.href, d = "custom"), c ? {id: c,type: d,s: a.search.replace(/^\?/, ""),p: x()} : !1
    }
    function A(a, b, c) {
        var e, f, g = a.video;
    ...
    function H(a, b, c, d) {
        ...
        if (f && (!e.l || e.l.W !== f.width || e.l.H !== f.height || e.l.r !== f.ratio || e.l.w !== b.w || e.l.h !== b.h || e.l.m !== c || e.l.p !== d)) {
            var g = f.width, i = f.height, j = b.w / b.h, k = f.ratio >= j, l = "scaledown" === c, m = "contain" === c, n = "cover" === c, p = Z(d);
            k && (l || m) || !k && n ? (g = h(b.w, 0, l ? g : 1 / 0), i = g / f.ratio) : (k && n || !k && (l || m)) && (i = h(b.h, 0, l ? i : 1 / 0), g = i * f.ratio), a.css({width: Math.ceil(g),height: Math.ceil(i),left: Math.floor(o(p.x, b.w - g)),top: Math.floor(o(p.y, b.h - i))}), e.l = {W: f.width,H: f.height,r: f.ratio,w: b.w,h: b.h,m: c,p: d}
        }
        return !0
    }
    function I(a, b) {
    ...
    function L(a, b, c) {
        c = c || {}, a.each(function() {
            ...
            f.clickOn || (f.clickOn = !0, d.extend(bb(e, {onStart: function(b) {
    ...
    function Z(a) {
        return a = (a + "").split(/\s+/), {x: p(a[0]) || ed,y: p(a[1]) || ed}
    }
    function $(a, b) {
        ...
        "undefined" != typeof b.overPos && b.overPos !== b.pos && (e = b.overPos, f = function() {
            $(a, d.extend({}, b, {overPos: b.pos,time: Math.max(Tc, b.time / 2)}))
        });
    ...
    function bb(a, c) {
        function e(a) {
            return m = d(a.target), u.checked = p = q = s = !1, k || u.flow || a.touches && a.touches.length > 1 || a.which > 1 || Dc && Dc.type !== a.type && Fc || (p = c.select && m.is(c.select, t)) ? p : (o = "touchstart" === a.type, q = m.is("a, a *", t), n = u.control, r = u.noMove || u.noSwipe || n ? 16 : u.snap ? 0 : 4, ab(a), l = Dc = a, Ec = a.type.replace(/down|start/, "move").replace(/Down/, "Move"), (c.onStart || g).call(t, a, {control: n,$target: m}), k = u.flow = !0, void ((!o || u.go) && X(a)))
        }
        function f(a) {
            if (a.touches && a.touches.length > 1 || Qc && !a.isPrimary || Ec !== a.type || !k)
                return k && h(), void (c.onTouchEnd || g)();
            ab(a);
            var b = Math.abs(a._x - l._x), d = Math.abs(a._y - l._y), e = b - d, f = (u.go || u.x || e >= 0) && !u.noSwipe, i = 0 > e;
            o && !u.checked ? (k = f) && X(a) : (X(a), (c.onMove || g).call(t, a, {touch: o})), !s && Math.sqrt(Math.pow(b, 2) + Math.pow(d, 2)) > r && (s = !0), u.checked = u.checked || f || i
        }
        function h(a) {
            (c.onTouchEnd || g)();
            var b = k;
    ...
    function cb(a, b) {
        ...
        function f(d, e) {
            D.noSwipe || (A || c(d), l = d._x, p.push([d._now, l]), n = m - (j - l), o = J(n, s, t), s >= n ? n = w(n, s) : n >= t && (n = w(n, t)), D.noMove || (a.css(k(n)), z || (z = !0, e.touch || Qc || a.addClass(dc)), (b.onMove || g).call(B, d, {pos: n,edge: o})))
        }
        function i(e) {
            if (!D.noSwipe || !e.moved) {
                ...
                u = h(n, s, t);
                var H = k - l, I = H >= 0, J = r - C, K = J > Sc, L = !K && n !== m && u === n;
        ...
        return D = d.extend(bb(b.$wrap, d.extend({}, b, {onStart: e,onMove: f,onEnd: i})), D)
    }
    function db(a, b) {
        var c, e, f, h = a[0], i = {prevent: {}};
        return S(h, Rc, function(a) {
            var h = a.wheelDeltaY || -1 * a.deltaY || 0, j = a.wheelDeltaX || -1 * a.deltaX || 0, k = Math.abs(j) && !Math.abs(h), l = Y(0 > j), m = e === l, n = d.now(), o = Sc > n - f;
    ...
    }(a, b), uc = {ok: !1,is: function() {
        return !1
    },request: function() {
    },cancel: function() {
    },event: "",prefix: ""}, vc = "webkit moz o ms khtml".split(" ");
    ...
    var yc, zc = {lines: 12,length: 5,width: 2,radius: 7,corners: 1,rotate: 15,color: "rgba(128, 128, 128, .75)",hwaccel: !0}, Ac = {top: "auto",left: "auto",className: ""};
    !function(a, b) {
        yc = b()
    }(this, function() {
        function a(a, c) {
    ...
    jQuery.Fotorama = function(a, e) {
        function f() {
            d.each(yd, function(a, b) {
                if (!b.i) {
                    ...
                    if (c) {
                        var d = {};
                        b.video = c, b.img || b.thumb ? b.thumbsReady = !0 : d = A(b, yd, he), B(yd, {img: d.img,thumb: d.thumb}, b.i, he)
                    }
                }
            })
        }
        ...
        function i(a) {
            var b = "keydown." + hb, c = hb + ie, d = "keydown." + c, f = "resize." + c + " orientationchange." + c;
            a ? (Ic.on(d, function(a) {
                var b, c;
                Cd && 27 === a.keyCode ? (b = !0, md(Cd, !0, !0)) : (he.fullScreen || e.keyboard && !he.index) && (27 === a.keyCode ? (b = !0, he.cancelFullScreen()) : a.shiftKey && 32 === a.keyCode && g("space") || 37 === a.keyCode && g("left") || 38 === a.keyCode && g("up") ? c = "<" : 32 === a.keyCode && g("space") || 39 === a.keyCode && g("right") || 40 === a.keyCode && g("down") ? c = ">" : 36 === a.keyCode && g("home") ? c = "<<" : 35 === a.keyCode && g("end") && (c = ">>")), (b || c) && X(a), c && he.show({index: c,slow: a.altKey,user: !0})
        ...
        function Ob(a, b, c, d) {
            (!Zd || "*" === Zd && d === Kd) && (a = p(e.width) || p(a) || Yc, b = p(e.height) || p(b) || Zc, he.resize({width: a,ratio: e.ratio || c || a / b}, 0, d !== Kd && "*"))
        }
        function Pb(a, b, c, f, g, h) {
            eb(a, b, function(a, i, j, k, l, m) {
                function n(a) {
                    var b = x(i);
                    ed(a, {index: b,src: w,frame: yd[b]})
                }
                function o() {
        ...
        function kc(a) {
            V(a, sd), W(a, function() {
                setTimeout(function() {
                    P(xe)
                }, 0), Kc({time: Ud,guessIndex: d(this).data().eq,minMax: Ne})
            })
        }
        function rc(a, b) {
        ...
        function tc(a) {
            eb(a, "stage", function(a, b, c, f, g, h) {
                if (f) {
                    ...
                    h.eq = i, Qe[$c][i] = f.css(d.extend({left: Rd ? 0 : q(b, Ke.w, e.margin, Fd)}, Rd && l(0))), E(f[0]) && (f.appendTo(re), md(c.$video)), sc(h.$img, Ke, j, k), sc(h.$full, Ke, j, k)
                }
            })
        }
        function vc(a, b) {
        ...
        function Fc() {
            Me.ok && (Me.prevent = {"<": Dc(0),">": Dc(1)})
        }
        function Gc(a) {
            var b, c, d = a.data();
            return Nd ? (b = d.l, c = d.w) : (b = a.position().left, c = a.width()), {c: b + c / 2,min: -b + 10 * e.thumbmargin,max: -b + Ke.w - c - 10 * e.thumbmargin}
        }
        function Jc(a) {
            var b = Dd[ge].data();
            $(Be, {time: 1.2 * a,pos: b.l,width: b.w - 2 * e.thumbborderwidth})
        }
        function Kc(a) {
            var b = yd[a.guessIndex][ge];
            if (b) {
                var c = Ne.min !== Ne.max, d = a.minMax || c && Gc(Dd[ge]), e = c && (a.keep && Kc.l ? Kc.l : h((a.coo || Ke.nw / 2) - Gc(b).c, d.min, d.max)), f = c && h(e, Ne.min, Ne.max), g = 1.1 * a.time;
                $(ye, {time: g,pos: f || 0,onEnd: function() {
                    vc(f, !0)
        ...
        function Rc(a) {
            for (var b = Pe[a]; b.length; )
                b.shift().removeClass(Vb)
        }
        function Uc(a) {
            var b = Qe[a];
        ...
        function jd() {
            if (clearTimeout(jd.t), !e.autoplay || be)
                return void (he.autoplay && (he.autoplay = !1, ed("stopautoplay")));
            he.autoplay || (he.autoplay = !0, ed("startautoplay"));
            var a = Ie, b = Dd[$c].data();
            F(function() {
                return b.state || a !== Ie
            }, function() {
        ...
        function od(a) {
            if (!Le.flow) {
                var b = a ? a.pageX : od.x, c = b && !Dc(xc(b)) && e.click;
        ...
        function pd(a) {
            clearTimeout(pd.t), e.clicktransition && e.clicktransition !== e.transition ? setTimeout(function() {
                var b = e.transition;
                he.setOptions({transition: e.clicktransition}), Vd = b, pd.t = setTimeout(function() {
                    he.show(a)
                }, 10)
            }, 0) : he.show(a)
        }
        function qd(a, b) {
            ...
            f.hasClass(lc) ? he.playVideo() : c === De ? he.toggleFullScreen() : Cd ? c === Ge && md(Cd, !0, !0) : b ? nd() : e.click && pd({index: a.shiftKey || Y(xc(a._x)),slow: a.altKey,user: !0})
        }
        function rd(a, b) {
            Le[a] = Ne[a] = b
        }
        function sd(a) {
            ...
            pd({index: b,slow: a.altKey,user: !0,coo: a._x - xe.offset().left})
        }
        function td(a) {
            pd({index: ve.index(this) ? ">" : "<",slow: a.altKey,user: !0})
        }
        function ud(a) {
            W(a, function() {
                setTimeout(function() {
        ...
        function vd() {
            ...
            if (zd) {
                if (wd())
                    return;
                Cd && md(Cd, !0), Ed = [], Uc($c), vd.ok = !0, he.show({index: Ie,time: 0}), he.resize()
            } else
                he.destroy()
        }
        function wd() {
        ...
        pe[$c] = d(M(xb)), pe[ad] = d(M(Lb + " " + Nb + qc, M(hc))), pe[_c] = d(M(Lb + " " + Mb + qc, M(gc))), Pe[$c] = [], Pe[ad] = [], Pe[_c] = [], Qe[$c] = {}, pe.addClass(Lc ? lb : kb).toggleClass(pb, !e.controlsonstart), me.fotorama = this, he.startAutoplay = function(a) {
            ...
            var i = g === Dd && !a.user;
            md(Cd, Dd.i !== yd[x(Fd)].i), rc(Ed, "stage"), tc(Pc ? [Gd] : [Gd, T(Gd), Z(Gd)]), rd("go", !0), i || ed("show", {user: a.user,time: d}), be = !0;
            var j = he.show.onEnd = function(b) {
                if (!j.ok) {
                    if (j.ok = !0, b || Wc(!0), i || ed("showend", {user: a.user}), !b && Vd && Vd !== e.transition)
                        return he.setOptions({transition: Vd}), void (Vd = !1);
                    dc(), Pb(Ed, "stage"), rd("go", !1), Fc(), od(), id(), jd()
                }
            };
            if (Rd) {
                var k = Dd[$c], l = Ie !== Hd ? yd[Hd][$c] : null;
                _(k, l, se, {time: d,method: e.transition,onEnd: j}, Se)
            } else
                $(re, {pos: -q(Gd, Ke.w, e.margin, Fd),overPos: f,time: d,onEnd: j});
            if (Ec(), Md) {
                Oc();
                var m = y(Ie + h(Gd - Hd, -1, 1));
                Kc({time: d,coo: m !== Ie && a.coo,guessIndex: "undefined" != typeof a.coo ? m : Ie,keep: i}), Nd && Jc(d)
            }
            ...
            cd(he.fullScreen ? {width: "100%",maxwidth: null,minwidth: null,height: "100%",maxheight: null,minheight: null} : Q(a), [Ke, c || he.fullScreen || e]);
            var d = Ke.width, f = Ke.height, g = Ke.ratio, i = Hc.height() - (Md ? xe.height() : 0);
            return p(d) && (pe.addClass(tb).css({width: d,minWidth: Ke.minwidth || 0,maxWidth: Ke.maxwidth || dd}), d = Ke.W = Ke.w = pe.width(), Ke.nw = Md && o(e.navwidth, d) || d, e.glimpse && (Ke.w -= Math.round(2 * (o(e.glimpse, d) || 0))), re.css({width: Ke.w,marginLeft: (Ke.W - Ke.w) / 2}), f = o(f, i), f = f || g && d / g, f && (d = Math.round(d), f = Ke.h = Math.round(h(f, o(Ke.minheight, i), o(Ke.maxheight, i))), qe.stop().animate({width: d,height: f}, b, function() {
                pe.removeClass(tb)
            }), Wc(), Md && (xe.stop().animate({width: Ke.nw}, b), Kc({guessIndex: Ie,time: b,keep: !0}), Nd && wc.nav && Jc(b)), Zd = c || !0, xd())), Re = qe.offset().left, this
        ...
        }, qe.on("mousemove", od), Le = cb(re, {onStart: fd,onMove: function(a, b) {
            ld(qe, b.edge)
            ...
            if (a.moved || b && a.pos !== a.newPos && !a.control) {
                ...
                he.show({index: c,time: Rd ? Ud : a.time,overPos: a.overPos,user: !0})
            } else
                a.aborted || a.control || qd(a.startEvent, b)
        },timeLow: 1,timeHigh: 1,friction: 2,select: "." + Wb + ", ." + Wb + " *",$wrap: qe}), Ne = cb(ye, {onStart: fd,onMove: function(a, b) {
            ld(xe, b.edge)
        },onTouchEnd: hd,onEnd: function(a) {
            function b() {
            ...
            if (a.moved)
                a.pos !== a.newPos ? (be = !0, $(ye, {time: a.time,pos: a.newPos,overPos: a.overPos,onEnd: b}), vc(a.newPos), Wd && ld(xe, J(a.newPos, Ne.min, Ne.max))) : b();
            else {
                var c = a.$target.closest("." + Lb, ye)[0];
                c && sd.call(c, a.startEvent)
            }
        },timeLow: .5,timeHigh: 2,friction: 5,$wrap: xe}), Me = db(qe, {shift: !0,onEnd: function(a, b) {
            fd(), hd(), he.show({index: b,slow: a.altKey})
        }}), Oe = db(xe, {onEnd: function(a, b) {
            fd(), hd();
            var c = u(ye) + .25 * b;
            ye.css(k(h(c, Ne.min, Ne.max))), Wd && ld(xe, J(c, Ne.min, Ne.max)), Oe.prevent = {"<": c >= Ne.max,">": c <= Ne.min}, clearTimeout(Oe.t), Oe.t = setTimeout(function() {
                Kc.l = c, vc(c, !0)
            }, Sc), vc(c)
        }}), pe.hover(function() {
            setTimeout(function() {
            ...
            fd(), Le.control = !0
        },onTouchEnd: hd}), ve.each(function() {
            V(this, function(a) {
                td.call(this, a)
            }), ud(this)
        ...
        var c = "", d = (sc.escape, Array.prototype.join);
