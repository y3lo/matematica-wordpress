...
(function($) {
    ...
    FlipClock.Time = FlipClock.Base.extend({
        ...
        toString: function() {
         ...
         getMonth: function() {
         return Math.floor(this.time / 60 / 60 / 24 / 365 * 12)%12;
         },
...
(function($) {
    ...
    FlipClock.DailyCounterFace = FlipClock.Face.extend({
        ...
        build: function(excludeHours, time) {
            ...
            if(this.showSeconds) {
                $(this.createDivider('Seconds',true)).insertBefore(this.factory.lists[this.factory.lists.length - 2].$obj);
            }
            else
            {
                offset = 2;
            ...
            $(this.createDivider('Minutes',true)).insertBefore(this.factory.lists[this.factory.lists.length - 4 + offset].$obj);
            $(this.createDivider('Hours',true)).insertBefore(this.factory.lists[this.factory.lists.length - 6 + offset].$obj);
            $(this.createDivider('Days',true)).insertBefore(this.factory.lists[this.factory.lists.length - 8 + offset].$obj);
            $(this.createDivider('Month',true)).insertBefore(this.factory.lists[this.factory.lists.length - 10 + offset].$obj);
            $(this.createDivider('Years',true)).insertBefore(this.factory.lists[0].$obj);
