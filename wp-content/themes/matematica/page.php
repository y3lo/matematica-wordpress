    ...
    <div class="content" id="fullpage">
        ...
        <div id="projects-my" class="content-block section">
            <div class="progect-page">
                ...
                <!-- Portfolio Filter -->
                <div class="filters"><span><?php _e("Ф И Л Ь Т Р Ы","matematica")?></span></div>
                ...
                <ul id="portfolio-list" class="project-list">
                    ...
                    <?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
                        ...
                        <li class="<?php foreach($category as $cat){echo $cat->slug." ";}?>">
                            <a href="<?php the_permalink()?>" onclick="return false;">
        ...
        <div id="contacts-my" class="content-block section">
            ...
            <div class="overflow">
                <div class="content-contener">
                    <div class="title" style="color: #fff;text-align: left;"><?php bloginfo("name")?></div>
                    <div class="text" style="color: #fff;text-align: left;">
                        <?php the_field("country");?><br><?php the_field("city");?><br><?php the_field("street");?><br><?php the_field("email");?><br><br><a href=\"tel:\"><?php the_field("phone-number");?></a>
                    </div>
                </div>
            </div>
